...
כל שקף: `1920×1080`, בתוך `.brief-stage`, עם ניווט מחוץ לשקף. שלד מלא לדוגמה: `טמפלט מצגת.html` בשורש הפרויקט (8 שקפים גנריים — שער, סדר יום, פתיח פרק, תוכן, השוואה, מדדים, לוח זמנים, תודה). **התחל תמיד ממנו.**
